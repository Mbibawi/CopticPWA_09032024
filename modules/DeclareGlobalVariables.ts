...
//CONSTANTS
const version: string = 'v4.3 (added inline mapping to complier)';
...
let displayMode: string = localStorage[0];
if (localStorage.displayMode == undefined) {localStorage.displayMode = displayMode};
