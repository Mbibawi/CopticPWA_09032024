        ...
        (function insertCymbalVersesAndDoxologiesForFeastsAndSeasons() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                //The order during the pentecostal days is important. We start by the last event (Pentecoste), then the "Ascension", and finally the general case which is Seasons.PentecostalDays
                    ...
                    moveBlockOfRowsAdjacentToAnElement(stMaykelRoot, "beforebegin", containerDiv.querySelectorAll('div[data-root="' +
...
const btnMassUnBaptised = new Button({
    ...
    afterShowPrayers: () => {
        (function insertStPaulReading() {
            let stPaul = btnReadingsStPaul.prayersArray.filter(tbl => tbl[0][0].split('&C=')[0] == btnReadingsStPaul.prayers[0] + copticReadingsDate);
            insertPrayersAdjacentToExistingElement(stPaul, { beforeOrAfter: 'beforebegin', el: containerDiv.querySelectorAll('div[data-root=""]')[0] });
        })();
    }
});
...
function insertGospelReadings(liturgy, goseplReadingsArray, languages) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let psalmReadingHtml = containerDiv.querySelectorAll('div[data-root="' +
            Prefix.commonPrayer +
            "GospelIntroductionPart2&D=0000".replace(/Part\d+/, "") +
            '"]')[4]; //This is the html element after which we will insert the psalm
...
function insertCymbalVersesForFeastsAndSeasons(param) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (param.remove) {
            containerDiv
                .querySelectorAll('div[data-root="' + cymbalsTitle.getAttribute("data-root") + '"]')
...
function removeElementsByTheirDataRoot(dataRoot) {
    return __awaiter(this, void 0, void 0, function* () {
        containerDiv
            .querySelectorAll('div[data-root="' + dataRoot + '"]')
            .forEach((el) => el.remove());
    });
}
